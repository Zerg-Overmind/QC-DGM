...
__C.PAIR.REF_GRAPH_CONSTRUCT = 'tri'
...
# QCDGM model options
__C.QCDGM = edict()
__C.QCDGM.FEATURE_CHANNEL = 512
__C.QCDGM.BS_ITER_NUM = 20
__C.QCDGM.BS_EPSILON = 1.0e-10
__C.QCDGM.SCALE_ALPHA = 200.
__C.QCDGM.GNN_LAYER = 5
__C.QCDGM.GNN_FEAT = 1024
