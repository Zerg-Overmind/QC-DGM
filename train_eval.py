...
from utils.fm_loss import FMLoss
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        for inputs in dataloader['train']:
            ...
            with torch.set_grad_enabled(True):
                # forward
                s_pred, U_src, F_src, U_tgt, F_tgt, AA_src, BB_tgt = \
                ...
                multi_loss = []
                loss = criterion(s_pred, perm_mat, n1_gt, n2_gt, G1_gt, G2_gt, H1_gt, H2_gt)
                ...
                acc, _, _ = matching_accuracy(lap_solver(s_pred, n1_gt, n2_gt), perm_mat, n1_gt)
